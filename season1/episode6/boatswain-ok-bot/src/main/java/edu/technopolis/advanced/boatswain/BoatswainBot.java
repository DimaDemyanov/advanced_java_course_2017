...
import edu.technopolis.advanced.boatswain.translation.Translator;
...
public class BoatswainBot {
    ...
    private static ApiClient createClient(Properties props) {
        ...
        String token = props.getProperty("ok.api.access_token");//tkn1UVxhqXQaeGsOGZh4YP7QcIqyG2mxHMMNlQnSJMd1N2NuFdGuAUB787WURqg4GQlGa:CBAJMDDMEBABABABA
...
//            }
            ...
            String message = null;
            try {
                message = Translator.callUrlAndParseResult(
                        "ru", "en", notif.getMessage().getText());
            } catch (Exception e) {
